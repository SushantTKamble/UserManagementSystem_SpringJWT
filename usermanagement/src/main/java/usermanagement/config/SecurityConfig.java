...
public class SecurityConfig {
	 ...
	 * 
	 * @Autowired private JWTAuthoFilter jwtAuthoFilter;
	 * 
	 * 
	 ...
	 * .authorizeHttpRequests(request->request.requestMatchers("/public/**").
	 ...
	 * jwtAuthoFilter,UsernamePasswordAuthenticationFilter.class );
	 * 
    ...
    @Autowired
    private JWTAuthoFilter jwtAuthFilter;
